...
export const buildEnhancedTreeFromFlatData = (dbRows) => {
    ...
    childrenGroups.forEach((children, key) => {
        ...
        console.log(`🔗 Processing ${children.length} children for parent ${parentId}, branch: ${isTrueBranch}`);
...
export const enhancedSampleDatabaseData = [
    ...
    // TRUE Branch: High Speed Operations (3 children)
    {
        ...
        branchIndex: 0,
        paramId: "000002",
        paramDesc: "High Speed Calculation 1",
    ...
    },
    {
        ...
        branchIndex: 1,
        paramId: "000003",
        paramDesc: "High Speed Calculation 2",
        moduleDesc: "Performance Module 2",
        uom: "MIN",
        operation: "+",
        standardMH: 15,
        ifChecked: false
    },
    {
        ...
        branchIndex: 2,
        paramId: "000004",
        paramDesc: "High Speed Calculation 3",
        moduleDesc: "Performance Module 3",
        uom: "HRS",
        operation: "*",
        standardMH: 5,
        ifChecked: false
    ...
    // FALSE Branch: Low Speed Operations (2 children)
    {
        ...
        branchIndex: 0,
        paramId: "000005",
        paramDesc: "Low Speed Calculation 1",
        moduleDesc: "Economy Module 1",
        uom: "SEC",
        operation: "*",
        standardMH: 10,
        ifChecked: false
    },
    {
        ...
        branchIndex: 1,
        paramId: "000006",
        paramDesc: "Low Speed Calculation 2",
        moduleDesc: "Economy Module 2",
        uom: "MIN",
        operation: "+",
        standardMH: 8,
        ifChecked: false
    ...
    // ================================
    {
        ...
        branchIndex: null,
        paramId: "000007",
        paramDesc: "Temperature Check",
        moduleDesc: "Temperature Control",
        uom: "TEMP",
        operation: "*",
        standardMH: 0,
        ifChecked: true,
    ...
    // TRUE Branch: Cold Temperature Handling
    {
        ...
        branchIndex: 0,
        paramId: "000008",
        paramDesc: "Cold Temperature Handler",
        moduleDesc: "Cold Weather Module",
        uom: "SEC",
        operation: "*",
        standardMH: 20,
    ...
    // Nested TRUE: Extreme Cold (Below 0°)
    {
        ...
        branchIndex: 0,
        paramId: "000009",
        paramDesc: "Extreme Cold Calculation 1",
        moduleDesc: "Arctic Module 1",
        uom: "MIN",
        operation: "*",
        standardMH: 45,
        ifChecked: false
    },
    {
        ...
        branchIndex: 1,
        paramId: "000010",
        paramDesc: "Extreme Cold Calculation 2",
        moduleDesc: "Arctic Module 2",
        uom: "HRS",
        operation: "+",
        standardMH: 30,
        ifChecked: false
    ...
    // Nested FALSE: Normal Cold (0° to 50°)
    {
        ...
        branchIndex: 0,
        paramId: "000011",
        paramDesc: "Normal Cold Calculation",
        moduleDesc: "Standard Cold Module",
        uom: "SEC",
        operation: "*",
        standardMH: 12,
        ifChecked: false
    ...
    // Additional TRUE child for Temperature root
    {
        ...
        branchIndex: 1,
        paramId: "000013",
        paramDesc: "General Cold Processing",
        moduleDesc: "Base Cold Module",
        uom: "SEC",
        operation: "+",
        standardMH: 8,
        ifChecked: false
    ...
    // FALSE Branch: Warm Temperature (Above 50°)
    {
        ...
        branchIndex: 0,
        paramId: "000012",
        paramDesc: "Warm Temperature Calculation",
        moduleDesc: "Warm Weather Module",
        uom: "MIN",
        operation: "+",
        standardMH: 5,
        ifChecked: false
    ...
    // ================================
    {
        ...
        branchIndex: null,
        paramId: "000014",
        paramDesc: "Pressure Level Check",
        moduleDesc: "Pressure Control System",
        uom: "PSI",
        operation: "*",
        standardMH: 0,
        ifChecked: true,
    ...
    // TRUE Branch: High Pressure (4 children)
    {
        ...
        branchIndex: 0,
        paramId: "000015",
        paramDesc: "High Pressure Processing 1",
        moduleDesc: "Pressure Module A",
        uom: "SEC",
        operation: "*",
        standardMH: 18,
        ifChecked: false
    },
    {
        ...
        branchIndex: 1,
        paramId: "000016",
        paramDesc: "High Pressure Processing 2",
        moduleDesc: "Pressure Module B",
        uom: "MIN",
        operation: "+",
        standardMH: 12,
        ifChecked: false
    },
    {
        ...
        branchIndex: 2,
        paramId: "000017",
        paramDesc: "Safety Override Check",
        moduleDesc: "Safety System",
        uom: "SEC",
        operation: "*",
        standardMH: 22,
        ifChecked: false
    },
    {
        ...
        branchIndex: 3,
        paramId: "000018",
        paramDesc: "Pressure Relief Calculation",
        moduleDesc: "Relief Valve Module",
        uom: "HRS",
        operation: "+",
        standardMH: 35,
        ifChecked: false
    ...
    // FALSE Branch: Normal Pressure (3 children)
    {
        ...
        branchIndex: 0,
        paramId: "000019",
        paramDesc: "Normal Pressure Operation 1",
        moduleDesc: "Standard Module 1",
        uom: "SEC",
        operation: "*",
        standardMH: 8,
        ifChecked: false
    },
    {
        ...
        branchIndex: 1,
        paramId: "000020",
        paramDesc: "Normal Pressure Operation 2",
        moduleDesc: "Standard Module 2",
        uom: "MIN",
        operation: "+",
        standardMH: 6,
        ifChecked: false
    },
    {
        ...
        branchIndex: 2,
        paramId: "000021",
        paramDesc: "Efficiency Optimization",
        moduleDesc: "Optimization Module",
        uom: "SEC",
        operation: "*",
        standardMH: 4,
        ifChecked: false
    ...
    // ================================
    {
        ...
        branchIndex: null,
        paramId: "000022",
        paramDesc: "Base Calculation Module",
        moduleDesc: "Foundation System",
        uom: "SEC",
        operation: "*",
        standardMH: 15,
    ...
    // ================================
    {
        ...
        branchIndex: null,
        paramId: "000023",
        paramDesc: "Fuel Efficiency Check",
        moduleDesc: "Fuel Management System",
        uom: "L/HR",
        operation: "*",
        standardMH: 0,
        ifChecked: true,
    ...
    // Deep Nested TRUE: Eco Mode Active
    {
        ...
        branchIndex: 0,
        paramId: "000025",
        paramDesc: "Maximum Efficiency Calculation",
        moduleDesc: "Max Efficiency Module",
        uom: "MIN",
        operation: "+",
        standardMH: 25,
        ifChecked: false
    ...
    // Deep Nested FALSE: Eco Mode Inactive
    {
        ...
        branchIndex: 0,
        paramId: "000026",
        paramDesc: "Standard Efficiency Calculation",
    ...
    // Additional TRUE child for Fuel root
    {
        ...
        branchIndex: 1,
        paramId: "000027",
        paramDesc: "Fuel Conservation Protocol",
        moduleDesc: "Conservation System",
        uom: "HRS",
        operation: "+",
        standardMH: 8,
        ifChecked: false
    ...
    // FALSE Branch: Inefficient Fuel Usage
    {
        ...
        branchIndex: 0,
        paramId: "000028",
        paramDesc: "High Consumption Processing",
    ...
    },
    {
        ...
        branchIndex: 1,
        paramId: "000029",
        paramDesc: "Fuel Warning System",
        moduleDesc: "Warning Module",
        uom: "MIN",
        operation: "+",
        standardMH: 5,
        ifChecked: false
